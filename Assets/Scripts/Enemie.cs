...
public class Enemie : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            Vector3 position = SceneManager.Instance.Player.transform.position;
    ...
    private void Die()
    {
        ...
        //Upon enemy death, player is given HP
        SceneManager.Instance.AddPlayerHP(GivenHpUponDeath);
        isDead = true;
